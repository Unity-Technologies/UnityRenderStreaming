...
namespace Unity.RenderStreaming.RuntimeTest
{
    class CommandLineParserTest
    {
        ...
        public void IceServerCredentialTypeArgument()
        {
            ...
            Assert.That(CommandLineParser.TryParse(arguments), Is.True);
            Assert.That((RTCIceCredentialType)CommandLineParser.IceServerCredentialType, Is.EqualTo(RTCIceCredentialType.Password));

            iceServerCredentialType = "oauth";
            arguments = new[] { "-iceServerCredentialType", iceServerCredentialType };
            Assert.That(CommandLineParser.TryParse(arguments), Is.True);
            Assert.That((RTCIceCredentialType)CommandLineParser.IceServerCredentialType, Is.EqualTo(RTCIceCredentialType.OAuth));
