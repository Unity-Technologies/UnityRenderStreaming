...
namespace Unity.RenderStreaming
{
    ...
    static class CommandLineParser
    {
        ...
        internal static readonly StringArgument SignalingType = new StringArgument("-signalingType", tryParse: TryParseSignalingType);
        ...
        internal static readonly EnumArgument<RTCIceCredentialType> IceServerCredentialType = new EnumArgument<RTCIceCredentialType>("-iceServerCredentialType");
        ...
        static bool TryParseSignalingType(string[] arguments, string argumentName, out string argumentValue)
        {
            string[] types = { "websocket", "http" };
            ...
            {
                case "websocket":
                    argumentValue = typeof(WebSocketSignaling).FullName;
                    return true;
                case "http":
                    argumentValue = typeof(HttpSignaling).FullName;
                    return true;
                default:
                    argumentValue = null;
                    return false;
