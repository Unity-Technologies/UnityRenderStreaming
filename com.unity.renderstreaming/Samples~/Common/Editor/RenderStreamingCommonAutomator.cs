...
public class RenderStreamingCommonAutomator
{
...
//---------------------------------------------------------------------------------------------------------------------
    ...
    public static void TryAddCommonPackageAndImportSample() {
...
//---------------------------------------------------------------------------------------------------------------------
    ...
    static void OnLoad() {
        ...
        TryAddCommonPackageAndImportSample();
    }
...
//---------------------------------------------------------------------------------------------------------------------
    ...
    static void ImportCommonSample() {
...
//---------------------------------------------------------------------------------------------------------------------
    ...
    static void Init() {
        ...
        m_settingsPath = dir + "/RenderStreamingCommonSettings.json";
        m_unityPackageSamplePath =  dir + "/RenderStreamingCommonSimple.unitypackage";
    }
...
//---------------------------------------------------------------------------------------------------------------------
    ...
    const string PROGRESS_BAR_INFO  = "Installing Common Sample";
