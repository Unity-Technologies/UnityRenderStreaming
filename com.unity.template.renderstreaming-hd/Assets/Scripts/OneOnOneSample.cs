...
#pragma warning restore 0649
    ...
    private void Awake()
    {
        WebRTC.Initialize(hardwareEncoderSupport ? EncoderType.Hardware : EncoderType.Software);
...
class SendRecvVideo : IDisposable
{
    ...
    RTCPeerConnection CreatePeerConnection(ISignaling signaling, string connectionId, bool isOffer)
    {
        ...
        pc.OnNegotiationNeeded = () => m_parent.StartCoroutine(OnNegotiationNeeded(signaling, connectionId, isOffer));
        return pc;
    }
