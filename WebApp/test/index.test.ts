...
describe('http signaling test in public mode', () => {
    const sessionId: string = "abcd1234";
    const headerMock = (id: string) => sessionId;
    const isPrivateMock = (str: string) => false;
    const connectionId: string = "12345";
...
describe('http signaling test in private mode', () => {
    const sessionId: string = "abcd1234";
    const headerMock = (id: string) => sessionId;
    const isPrivateMock = (str: string) => true;
    const connectionId: string = "12345";
